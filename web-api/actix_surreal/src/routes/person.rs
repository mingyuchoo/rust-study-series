    use crate::{error::AppError, db::DB};
    ...
    #[post("/person/{id}")]
    pub async fn create_person(id: Path<String>, person: Json<PersonData>) -> Result<Json<Option<Person>>, AppError> {
    ...
    #[put("/person/{id}")]
    pub async fn update_person(id: Path<String>, person: Json<PersonData>) -> Result<Json<Option<Person>>, AppError> {
