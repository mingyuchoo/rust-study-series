...
#+BEGIN_SRC shell
  mkdir crates
  cd crates
  cargo new --lib library-one
  cargo new --lib library-two
  cargo new --lib library-three
  cd ..
#+END_SRC
The project name will be added to =members= of ~Cargo.toml~ automatically.
#+BEGIN_SRC toml
...
- ~crates/library-one/src/lib.rs~
#+BEGIN_SRC rust
  pub fn add_one(x: i32) -> i32 {
    x + 1
  }
#+END_SRC
- ~crates/library-two/src/lib.rs~
#+BEGIN_SRC rust
  pub fn add_two(x: i32) -> i32 {
    x + 2
  }
#+END_SRC
- ~crates/library-three/src/lib.rs~
#+BEGIN_SRC rust
...
#+END_SRC
*** 4. Add dependencies main project
Add dependencies in ~Cargo.toml~ file of =apps/cli= project
#+BEGIN_SRC toml
  [package]
  name = "server"
  version = "0.1.0"
  ...
  [dependencies]
  library-one   = { path = "../../crates/library-one"}
  library-two   = { path = "../../crates/library-two"}
  library-three = { path = "../../crates/library-three"}
#+END_SRC
*** 5. Use three libraries main project
Use three libraries in =apps/cli= project
