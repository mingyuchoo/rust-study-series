...
use crate::domain::{
    entities::{Contact, CreateContactRequest, UpdateContactRequest},
    errors::{ContactError, ContactResult},
...
impl ContactService {
    ...
    pub async fn get_all_contacts(&self) -> ContactResult<Vec<Contact>> {
    ...
    pub async fn delete_contact(&self, id: Uuid) -> ContactResult<()> {
