                ...
                error.get().map(|err| {
                    view! {
                        <div class="error-banner">
                            <span>{err}</span>
                            <button class="error-close" on:click=move |_| set_error.set(None)>
                                "×"
                            </button>
                        </div>
                    }
                        ...
                        view! {
                            <div class="contact-form-container">
                                <div class="contact-form-card">
                                    <h2 class="form-title">
                                        {if editing_contact.get().is_some() {
                                            "연락처 수정"
                                        } else {
                                            "새 연락처 추가"
                                        }}
                                                                ...
                                                                <div class="contact-card">
                                                                    ...
                                                                    <div class="contact-actions">
                                                                        <button
                                                                            ...
                                                                            on:click=move |_| {
                                                                                set_editing_contact
                                                                                    .set(Some(contact_for_edit.clone()));
                                                                                set_show_form.set(true);
                                                                            }
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            on:click=move |_| {
                                                                                ...
                                                                                {
                                                                                    spawn_local(async move {
                                                                                        match ContactApi::delete_contact(
        ...
        <form on:submit=handle_submit class="contact-form">
            ...
            {move || {
                form_error.get().map(|err| {
                    view! { <div class="error-message">{err}</div> }
                })
            }}
