...
//!
//! This example demonstrates the greeting processing logic without starting a
//! server. Useful for testing the business logic independently.
//!
...
fn main() -> Result<(), AppError> {
    ...
    let test_names = vec![
        "Alice", "Bob", "世界", // World in Japanese
    ...
    for (i, name) in test_names.iter().enumerate() {
        ...
        match process_greeting_request(name.to_string()) {
