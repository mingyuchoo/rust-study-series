use crate::{agent_core::{config::EvaluationConfig,
                         ...
                         models::{AgentState,
                                  ...
                                  ToolCall,
                                  Trajectory}},
            execution::base_agent::{AgentMetadata,
                                    BaseAgent},
            execution_tools::registry::ToolRegistry};
...
impl BaseAgent for PpaAgent {
    ...
    fn load_domain_tools(&mut self, domain_config: &crate::agent_core::domain_config::DomainConfig) {
        let mut registry = self.tools.lock().unwrap();
        match domain_config.name.as_str() {
            | "financial" => {
                registry.register(Arc::new(crate::domains::financial::tools::SimpleInterestCalculatorTool::new()));
                registry.register(Arc::new(crate::domains::financial::tools::CompoundInterestCalculatorTool::new()));
                registry.register(Arc::new(crate::domains::financial::tools::TransactionValidatorTool::new()));
            },
            | "customer_service" => {
                registry.register(Arc::new(crate::domains::customer_service::tools::ClassifyInquiryTool::new()));
                registry.register(Arc::new(crate::domains::customer_service::tools::ProcessRefundTool::new()));
                registry.register(Arc::new(crate::domains::customer_service::tools::EscalateIssueTool::new()));
            },
            | _ => {},
        }
    }
