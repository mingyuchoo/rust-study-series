use super::{base_agent::BaseAgent,
            models::{EvaluationReport,
                     ScenarioResult}};
use crate::{agent_core::models::EvaluationResult,
            data_scenarios::{loader::ScenarioLoader,
                             models::Scenario},
            reporting::logger::TrajectoryLogger,
            scoring::evaluator::TrajectoryEvaluator};
use anyhow::Result;
use chrono::Utc;
use colored::*;
